...
<div class="container">
    ...
    <form action="../recipemanagement/recipe_post_update.php" method="POST">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" placeholder="VolezPasLaRecetteDesAutreSvpcpagenti" id="recipe" name="recipe"><?php echo $recipe['recipe']; ?></textarea>
        </div>
