...
<body class="d-flex flex-column min-vh-100">
    <div class="container">
        ...
        <form action=../recipemanagement/recipe_post_create.php method="POST">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" placeholder="VolezPasLaRecetteDesAutreSvpcpagenti" id="recipe" name="recipe"></textarea>
            </div>
